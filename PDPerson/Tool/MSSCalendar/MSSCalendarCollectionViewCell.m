...
- (void)createCell
{
    ...
    _dateLabel = [[MSSCircleLabel alloc]initWithFrame:CGRectMake(0, MSS_Iphone6Scale(10), self.contentView.frame.size.width, self.contentView.frame.size.height - MSS_Iphone6Scale(10)/*self.frame.size.height / 2 - MSS_Iphone6Scale(10)*/)];
...
- (void)setSelected:(BOOL)selected{
    ...
    _dateLabel.isSelected = selected;
}
